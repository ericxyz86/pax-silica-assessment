...
- **Site version** — this repository, currently **v1.27**. Any copy change bumps it, in all three
...
- **Assessment version** — the underlying research, currently **v2.11**, maintained separately with
  its own change log.
